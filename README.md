...
This project implements a **Multi-SCM** checkout architecture. It pulls the main application code from this repository (`jenkins-docker-cicd-pipeline`), and pulls deployment configurations from a secondary repository (`pipeline-deployment-configs`).

## 🏗️ Pipeline Architecture

1. **Multi-SCM Checkout**: Jenkins pulls code from `jenkins-docker-cicd-pipeline` (App) and `pipeline-deployment-configs` (Config).
